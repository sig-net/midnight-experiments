...
- Real-world custom-event pattern in this org's OLD checkout: `signet-signer.compact` in the old MVP (git history of sig-net/midnight-integration, e.g. `git show 99ee0c6:boilerplate/contract/src/signet-signer.compact`) (`emitPart` circuit).
